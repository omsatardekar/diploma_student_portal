                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="text-muted">
                                ...
                                <h5 class="font-size-15 mb-2"><?php echo $student->name ?></h5>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <strong>Class: </strong>
                <?php echo isset($usermeta['class']) ? $usermeta['class'] : 'Student class not assigned'; ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($paid) { ?>
                                <a href="?action=view-invoice&month=<?php echo $value ?>&std_id=<?php echo $std_id ?>"
                                ...
                                <a href="#" data-toggle="modal" data-month="<?php echo ucwords($value) ?>"
                                    data-target="#paynow-popup" class="btn btn-sm btn-warning paynow-btn"><i
                                        class="fa fa-money-check-alt fa-fw"></i> Pay Now</a>
                                <?php } ?>
...
<!-- Modal -->
<div class="modal fade" id="paynow-popup" tabindex="-1" role="dialog" aria-labelledby="paynow-popupLabel"
    aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="month" readonly class="form-control" id="month"
                                    value="<?php echo $student->name ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <button id="rzp-button" class="btn btn-success mt-3">Pay with Razorpay</button>
                            </div>
                        </div>
                    </div>
                </form>
...
document.getElementById('rzp-button').onclick = function(e) {
    e.preventDefault();
    var options = {
        "key": "rzp_test_5PqllnPIYLwNHf", // Enter your Razorpay Key ID
        "amount": "50000", // Amount is in paise (₹500)
        "currency": "INR",
        "name": "School Name",
        "description": "Fee Payment",
        "image": "path-to-school-logo.png",
        "handler": function(response) {
            alert('Payment successful. Razorpay Payment ID: ' + response.razorpay_payment_id);
            // You can add AJAX here to store payment info in the backend
        },
        "prefill": {
